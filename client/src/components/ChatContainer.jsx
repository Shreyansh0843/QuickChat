    ...
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      <div className='flex items-center gap-3 py-3 mx-4 border-b border-stone-500'>
        ...
        <p className='flex-1 text-lg text-white flex items-center gap-2'>
          ...
          <img src={assets.help_icon} alt="" className='max:mid-hidden max-w-5' />
      </div>
      ...
      {/* ----- bottom area ---- */}
      <div className="w-full px-4 pb-4 absolute bottom-0 left-0 right-0">
  <div className="flex items-center w-full bg-white/10 backdrop-blur-md rounded-full px-4 py-3">
    ...
    <input
      ...
      className="flex-1 ml-3 bg-transparent text-gray-200 placeholder-gray-400 focus:outline-none text-base"
    />
    ...
    <img 
      ...
      alt="send" 
      className="w-6 ml-3 cursor-pointer opacity-90 hover:opacity-100 transition"
    />
